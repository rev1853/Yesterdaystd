...
export default function AlbumDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d]">
      ...
      {/* Hero Section */}
      <div className="relative h-[300px] sm:h-[450px] md:h-[550px] lg:h-[720px] mt-[100px] sm:mt-[130px] lg:mt-[172px] overflow-hidden">
                ...
                <div className="relative rounded-xl sm:rounded-[12px] lg:rounded-[15px] overflow-hidden">
                  ...
                  {isClient ? (
                    <>
                      ...
                      {/* Selection checkbox */}
                      <div 
                        className={`absolute top-2 sm:top-3 lg:top-4 right-2 sm:right-3 lg:right-4 w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full border-2 flex items-center justify-center transition-all duration-300 cursor-pointer z-10 ${
                          isSelected
