          ...
          <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-7 lg:space-y-8">
            ...
            <div>
              ...
              {photos.length > 0 ? (
                  ...
                  {photos.map((photo, index) => (
                    <div key={index} className="relative group">
                      <img
                        src={photo}
                        alt={`Photo ${index + 1}`}
                        className="w-full h-[150px] sm:h-[180px] lg:h-[200px] object-cover rounded-xl"
                      />
                      <button
                        type="button"
                        onClick={() => handleRemovePhoto(index)}
                        className="absolute top-2 right-2 p-1.5 sm:p-2 bg-red-500 text-white rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
                      >
                ...
                <div className="border-2 border-dashed border-neutral-800 rounded-xl p-8 sm:p-10 lg:p-12 text-center">
                  <Upload className="w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 text-neutral-700 mx-auto mb-3 sm:mb-4" />
                  <p className="font-['Inter'] text-[14px] sm:text-[15px] lg:text-[16px] text-neutral-500">
                    No photos added yet
                  </p>
                  <p className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-600 mt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6 sm:pt-7 lg:pt-8">
              <button
                type="button"
                onClick={() => navigate('/creator')}
                className="w-full sm:flex-1 py-3 sm:py-3.5 lg:py-4 bg-neutral-800 text-neutral-100 rounded-xl font-['Inter'] font-medium text-[14px] sm:text-[15px] lg:text-[16px] hover:bg-neutral-700 transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                className="w-full sm:flex-1 py-3 sm:py-3.5 lg:py-4 bg-neutral-100 text-[#0d0d0d] rounded-xl font-['Inter'] font-extrabold text-[14px] sm:text-[15px] lg:text-[16px] tracking-[-0.7px] sm:tracking-[-0.75px] lg:tracking-[-0.8px] hover:bg-neutral-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Create Album
              </button>
            </div>
