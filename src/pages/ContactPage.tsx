      ...
      <div className="pt-[120px] sm:pt-[150px] md:pt-[180px] lg:pt-[200px] pb-[60px] sm:pb-[80px] lg:pb-[100px] px-4 sm:px-8 md:px-16 lg:px-[138px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-7 lg:gap-8 mb-10 sm:mb-12 lg:mb-16">
          ...
          <div className="space-y-6 sm:space-y-7 lg:space-y-8">
            ...
            <div className="bg-[#1e1e1e] rounded-xl p-5 sm:p-6 border-2 border-neutral-800">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-400">Monday - Friday</span>
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">9:00 AM - 6:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-400">Saturday</span>
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">10:00 AM - 4:00 PM</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-400">Sunday</span>
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">Closed</span>
                </div>
              </div>
            </div>
            ...
            {/* Social Media */}
            <div className="bg-[#1e1e1e] rounded-xl p-5 sm:p-6 border-2 border-neutral-800">
              <h3 className="font-['Inter'] font-extrabold text-[16px] sm:text-[18px] lg:text-[20px] text-neutral-100 tracking-[-0.8px] sm:tracking-[-0.9px] lg:tracking-[-1px] mb-3 sm:mb-4">
                Follow Us
              </h3>
              <div className="flex gap-2 sm:gap-3">
                <a href="#" className="flex-1 py-2.5 sm:py-3 bg-[#0d0d0d] rounded-lg hover:bg-neutral-800 transition-colors flex items-center justify-center gap-1.5 sm:gap-2">
                  <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-neutral-100" />
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">Instagram</span>
                </a>
                <a href="#" className="flex-1 py-2.5 sm:py-3 bg-[#0d0d0d] rounded-lg hover:bg-neutral-800 transition-colors flex items-center justify-center gap-1.5 sm:gap-2">
                  <Facebook className="w-4 h-4 sm:w-5 sm:h-5 text-neutral-100" />
                  <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">Facebook</span>
                </a>
              </div>
              <a href="#" className="w-full mt-2 sm:mt-3 py-2.5 sm:py-3 bg-[#0d0d0d] rounded-lg hover:bg-neutral-800 transition-colors flex items-center justify-center gap-1.5 sm:gap-2">
                <Twitter className="w-4 h-4 sm:w-5 sm:h-5 text-neutral-100" />
                <span className="font-['Inter'] text-[12px] sm:text-[13px] lg:text-[14px] text-neutral-100">Twitter</span>
              </a>
            </div>
          </div>
        </div>
