...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d]">
      ...
      {/* Hero Section */}
      <div className="relative h-[500px] sm:h-[600px] lg:h-[720px] mt-[100px] sm:mt-[130px] lg:mt-[169px] overflow-hidden">
        <div aria-hidden="true" className="absolute inset-0">
          {/* Extra dark backdrop overlay */}
      ...
      <div className="px-4 sm:px-8 md:px-16 lg:px-[138px] py-12 sm:py-16 md:py-20 lg:py-[100px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-10 sm:mb-12 lg:mb-16">
          {features.map((feature, index) => (
            ...
            >
              <div className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mb-4 sm:mb-5 lg:mb-6 ${
